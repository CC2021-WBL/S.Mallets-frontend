...
import carpet2 from '../../assets/carpetAbout.png';

const AboutMe = () => {
  const { t } = useTranslation('about');
  return (
    <div className="relative mx-6 my-12 w-full max-w-7xl px-3 md:px-6 lg:px-8">
      <div className="hero-about mx-4 mb-14" />
      <div className="  mx-4 mb-14 h-fit w-full md:w-1/2 lg2:mb-0 lg2:h-[25rem] ">
        <LogoCarpet className="absolute -top-[155px] right-12 z-[1] hidden lg:block " />
